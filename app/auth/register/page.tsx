  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden w-1/2 lg:block">
        <img src="/group-of-healthy-pigs-in-clean-modern-farm-ivory-c.jpg" alt="Élevage porcin" className="h-full w-full object-cover" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent" />

        <div className="absolute bottom-12 left-12 right-12">
          <div className="rounded-2xl bg-white/10 p-6 backdrop-blur-xl">
            <h3 className="text-xl font-semibold text-white">Pourquoi choisir PorkyFarm ?</h3>
      ...
      <div className="flex w-full flex-col justify-center px-6 py-12 lg:w-1/2 lg:px-16">
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-muted-foreground">Commencez à gérer votre élevage intelligemment</p>
          </div>
